...
I686_TARGET=i686-pc-linux-gnu
I686_NEWLIB_TARGET=i686-pc-linux-gnu
...
buildi686() {
	...
	makedirs
	copy_makerules i686
	echo "******* Building i686 binutils"
	buildbinutils $I686_TARGET i686
	...
	buildgdb $I686_TARGET i686
	echo "******* i686 toolchain built and installed"
}
